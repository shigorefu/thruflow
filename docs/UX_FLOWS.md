...
- `日`: a chronological vertical timeline of every actual Flow and rest record for the selected app day, with stable-size cards, spacious internal `記録なし` gaps, and a separate system sheet for the canonical editor;
